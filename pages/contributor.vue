  ...
  <main class="container pt-3">
    ...
    <article class="font-mono tracking-wide leading-normal sm:text-justify max-w-md py-4 mb-16">
      ...
      <p class="text-lg mb-4">
        ...
        Ten je domov pro miliony zdrojových kódů všemožných projektů. Pohybují se zde primárně programátoři.
      ...
      <p class="text-lg mb-4">
        Nejdříve je potřeba si na Githubu udělat účet. Pokud účet již máte stačí se jen přihlásit (Sign in).
        Pokud se chystáte na svojí první úpravu či přidání nového zápisu, zajímá vás tlačítko registrace (Sign up).
        Tlačítka naleznete v pravém horním roku stránky. Celá registrace je samozřejmě zdarma.
      </p>
      ...
      <p class="text-lg mb-4">
        Nyní můžeme začít sepisovat náš nový zápis. Hned do editoru pod políčkem na nastavení názvu souboru (Edit new file).
      </p>
      ...
      <p class="text-lg mb-4">
        ...
        Před odesláním ještě můžete doplnit informace pro toho, kdo bude Váš záznam kontrolovat (Add an optional extended description..).
      </p>
      ...
      <p class="text-lg mb-4">
        Po úpravě je nutné tyto změny odeslat ke kontrole.
        To provedete dole na stránce kliknutím na tlačítko odeslat (Propose file change).
      ...
      <p class="text-lg mb-4">
        ...
        Kliknutím na ikonku koše se dostane přímo na stránku, kde můžete navrhnout smazání záznamu.
      </p>

      <p class="text-lg mb-4">
        Smazání by mělo být vždy nějak odůvodněno (Add an optional extended description).
        Urychlí se tak jeho zpracování. Poté klikneme na odeslat (Propose file change).
      </p>
    </article>
  </main>
</template>
